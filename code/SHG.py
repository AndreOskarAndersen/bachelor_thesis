...
Original file is located at
    https://colab.research.google.com/drive/1nARcln5W8Go3wwazYsveQ08A_xZWp_Ok
"""
    ...
    for epoch in tqdm(range(NUM_EPOCHS)):
      for x, heatmaps in zip(X, all_heatmaps):
        ...
        for i in range(model.num_hourglasses):
          loss += criterion(torch.tensor(model.pred[i], requires_grad=True).reshape((heatmaps.shape)), heatmaps)
        print(loss)
